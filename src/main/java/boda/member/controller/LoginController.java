...
public class LoginController {
   ...
   private final String getPage6="redirect:/movie.look"; //로그인성공하면 영화메인페이지로
   ...
   private final String gotoMain="redirect:/movie.look"; //탑에서 로그아웃아이콘 클릭하면 로그아웃처리
   ...
   public String logout(HttpSession session,HttpServletResponse response) throws IOException {
      ...
      writer.println("<script> alert('로그아웃 완료'); </script>");
      writer.println("<script> location.href='movie.look' </script>");
      writer.flush();
      return null;
   }
